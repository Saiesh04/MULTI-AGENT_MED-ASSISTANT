...
class AgentConfig:
    ...
    # Decision model
    DECISION_MODEL = "gemini-2.5-flash"  # Using Gemini 2.5 Flash for fast, cost-effective decisions
...
def create_agent_graph():
    ...
    def analyze_input(state: AgentState) -> AgentState:
        ...
        # Check input through guardrails if text is present, but skip for image uploads
            ...
            if not is_allowed:
                return {
                    **state,
                    ...
                    "bypass_routing": True,  # Bypass normal routing
                    "output": AIMessage(content=message)
                }

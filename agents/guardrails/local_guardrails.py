...
class LocalGuardrails:
    ...
    def __init__(self, llm):
        ...
        self.input_check_prompt = PromptTemplate.from_template(
            ...
            ALWAYS ALLOW these medical-related requests:
            - Medical image analysis (X-rays, MRIs, CT scans, skin lesions, etc.)
            - Medical image diagnosis and interpretation
            - Upload and analysis of medical images
            - Questions about medical conditions and symptoms
            - Web search for medical information
            - Search for similar medical cases
            - Research medical conditions
            - Find medical studies or papers
            - Medical advice and recommendations
            - Healthcare-related queries
            - Analysis of uploaded medical images
            - Diagnosis requests for medical images
            ...
            IMPORTANT: Medical image analysis and diagnosis requests are ALWAYS SAFE and appropriate.
            
            Respond with ONLY "SAFE" if the content is appropriate for a medical chatbot.
            If not safe, respond with "UNSAFE: [brief reason]".
            
            Remember: Medical image analysis, diagnosis requests, and healthcare queries are ALWAYS SAFE.
            """
        )
